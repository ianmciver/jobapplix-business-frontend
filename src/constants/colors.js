export const backgroundGrey = "#2b2d2d";
export const backgroundBlue = "#00c2ea";
export const backgroundGreen = "#1ee7e2";
...
export const textDark = "#2b2d2d";
export const textMedium = "#707070";
